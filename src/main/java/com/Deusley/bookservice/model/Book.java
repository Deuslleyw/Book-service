...
public class Book implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Book book = (Book) o;
        return id.equals(book.id) && author.equals(book.author) && launchDate.equals(book.launchDate) 
                && price.equals(book.price) && title.equals(book.title)
                && currency.equals(book.currency) && environment.equals(book.environment);
    }
